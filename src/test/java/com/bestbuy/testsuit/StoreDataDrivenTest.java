...
public class StoreDataDrivenTest extends TestBase {
    ...
    public void test001() {
        ...
        servicesData.put("name","Radhika");
        servicesData.put("createdAt","2023-07-01");
        servicesData.put("updatedAt","2023-07-01");
        Map<String,Object>storeServices=new HashMap<String,Object>();
        storeServices.put("createdAt","2023-07-01");
        storeServices.put("updatedAt","2023-07-01");
